...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://192.168.0.102/code-repo/hybrid/hybrid.html"]]];
...
//    };
    ...
    ctx[@"LNJSBridge"] = ^NSDictionary *(NSString *eventName, NSString *params) {
